...
3. Expand **Configure a business workflow** and use **Process Studio** to add ordered process steps, capture durable reference screenshots, or start a guided agent recording. Click **Save workflow configuration** to keep the complete definition and **Save executable recipe** after defining steps. Save credentials separately and test the recipe in chat before scheduling it.
