...
3. Expand **Configure a business workflow** to choose UI/background/headless mode, an encrypted credential profile reference, and a daily or HTTP change trigger. Save credentials in the form, then start a chat and ask the agent to record, test and save the recipe under the same name.
