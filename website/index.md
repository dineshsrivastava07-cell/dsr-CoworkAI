...
features:
  ...
  - icon: 📡
    ...
    details: Coordinate Indian remote desktop support workflows with Zoho Assist or ManageEngine-style VNC tooling, plus approved collaboration integrations.
  - icon: 🛡️
