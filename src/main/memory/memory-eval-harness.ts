...
const DEFAULT_EVAL_CASES: MemoryEvalCase[] = [
  {
    ...
    messages: [
      {
        role: 'user',
        text: 'From now on, please default to concise bullet-point answers.',
        timestamp: 1,
      },
      {
        role: 'assistant',
        text: 'Understood, I will default to concise bullet-point answers.',
        timestamp: 2,
      },
      {
        role: 'user',
        text: 'In workspace A, implement gateway token rotation, and record the remote gateway sync constraint.',
        timestamp: 3,
      },
      {
        role: 'assistant',
        text: 'Completed gateway token rotation, and noted that the remote gateway needs a synced update.',
        timestamp: 4,
      },
    ],
    queries: [
      {
        id: 'query-a1',
        prompt:
          'Continue the gateway token rotation, remind me of the key constraint from last time.',
        workspace: '/eval/workspace-a',
  ...
  },
  {
    ...
    messages: [
      {
        role: 'user',
        text: 'In workspace B, we decided not to merge the refunded and cancelled order states.',
        timestamp: 10,
      },
      {
        role: 'assistant',
        text: 'Noted: refunded and cancelled represent different financial semantics and must remain separate states.',
        timestamp: 11,
      },
    ],
    queries: [
